# Run all tests in the solution with cleaner output
# Usage: .\run-tests.ps1

Write-Host "Running all tests in solution..." -ForegroundColor Cyan
Write-Host ""

$output = dotnet test RadarrSonarrMcp.sln 2>&1 | Out-String
